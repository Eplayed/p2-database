...
// poe.ninja uses a compact protobuf payload for its build search endpoint.
// Keep the schema here instead of depending on their browser bundle at runtime.
const root = protobuf.parse(`
  ...
  message SearchResultDimensionCount { uint32 key = 1; uint32 count = 2; }
  message SearchResultIntegerDimension { string id = 1; uint32 min_value = 2; uint32 max_value = 3; }
  ...
  message SearchResultValue { string str = 1; uint32 number = 2; repeated uint32 numbers = 3; repeated string strs = 4; bool boolean = 5; }
...
module.exports = {
  SearchResult: root.lookupType('NinjaSearchResult'),
  SearchResultDictionary: root.lookupType('SearchResultDictionary')
};
