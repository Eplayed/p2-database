...
const MANUAL_TRANSLATIONS = {
  ...
  'Warding Starlit Ore': '守护星光矿',
  "Craiceann's Rune of Warding": '克雷斯安的守护符文',
  'Soul Core of Quipolatl': '奎波拉特尔的灵魂核心',
  ...
  'Omen of Secret Compartments': '秘密隔间预兆',
  'Omen of Light': '光明预兆',
  'Omen of Abyssal Echoes': '深渊回响预兆',
  'Cryptic Key': '隐秘钥匙',
  'Omen of the Hunt': '狩猎预兆',
  'Omen of Amelioration': '改善预兆',
  'Omen of Chaotic Quantity': '混沌数量预兆',
  "Astrid's Creativity": '阿斯特丽德的创造力',
  "Cadigan's Epiphany": '卡迪根的顿悟',
  "Olroth's Crest of the Sun": '奥尔罗斯的太阳冠饰',
  "Kolr's Hunt": '科尔的狩猎',
  'Sovereign Alloy': '君主合金',
  'Exceptional Verisium': '卓越维里西姆',
  'Veridical Starlit Ore': '真实星光矿',
  ...
  "Breachlord's Amalgam": '裂隙领主聚合体',
  'Cowardly Fate': '怯懦命运',
  'Deadly Fate': '致命命运',
  'Victorious Fate': '胜利命运',
  'Breachlord Sac': '裂隙领主祭品',
  'Simulacrum': '拟像异界',
  'Ritualistic Reliquary Key': '祭祀圣物钥匙',
  'Carved Majesty': '雕刻威严',
  'Carved Cunning': '雕刻狡黠',
  'Perfect Flux': '完美通量',
  "Ulaman's Gaze": '乌拉曼之凝视',
  "Kurgal's Gaze": '库尔加之凝视',
};
