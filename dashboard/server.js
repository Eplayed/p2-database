...
const TASKS = [
  ...
  },
  {
    ...
    description: '刷新当前 POE1 赛季天梯角色、热门主技能和游戏内通货行情，并上传 POE1 专用 OSS 路径；不会影响 POE2 数据。',
    group: 'recommended',
    steps: ['poe1_ladder', 'poe1_economy', 'poe1_upload'],
  },
  {
  ...
  },
  {
    id: 'poe1_ladder',
    name: '生成 POE1 天梯摘要',
    description: '读取 poe.ninja POE1 当前赛季公开天梯，生成职业、主技能和可查看的代表 BD 摘要。',
    group: 'single',
    hidden: true,
  ...
  },
  {
    ...
    description: '将 POE1 小程序摘要上传到 poe1-season 独立前缀。',
    group: 'single',
    hidden: true,
